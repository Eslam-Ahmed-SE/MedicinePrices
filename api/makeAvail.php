    ...
    function makeAvail($id) {
        ...
        if ($result->num_rows != null) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                $sqlUpdate = "UPDATE drugs SET availability='" . $row["availability"] . "|" . $this->pharmID . "' WHERE id=" . $id;

                if ($conn->query($sqlUpdate) === TRUE) {
                    return '{"success":   {"text": "Drug made available successfully",
                                         "code": 20}}';
                } else {
            ...
            return '{"error":   { "text": "no result for this drug id",
                                            "code": 14}}';
        }
